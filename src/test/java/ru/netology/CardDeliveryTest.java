...
public class CardDeliveryTest {
    ...
    void testPositiveAllInput() {
        ...
        form.$("[data-test-id='name'] input").setValue("Владимир Владимиров");
    ...
    void testNegativeCityNotValid(){
        open("http://localhost:9999/");
        SelenideElement form = $("[action='/']");
        form.$("[data-test-id='city'] input").setValue("Москва1111");
        form.$("[data-test-id='date'] input").doubleClick().sendKeys(Keys.BACK_SPACE);
        form.$("[data-test-id='date'] input").setValue(meetingDay(3));
        form.$("[data-test-id='name'] input").setValue("Владимир Владимиров");
        form.$("[data-test-id='phone'] input").setValue("+79642682654");
    ...
    void testNegativeDateEmpty(){
        ...
        SelenideElement form = $("[action='/']");
        form.$("[data-test-id='city'] input").setValue("Москва");
        form.$("[data-test-id='date'] input").doubleClick().sendKeys(Keys.BACK_SPACE);        form.$("[data-test-id='name'] input").setValue("Владимир Владимиров");
        form.$("[data-test-id='phone'] input").setValue("+79642682654");
        form.$("[data-test-id='agreement']").click();
        form.$(".button__content").click();
    ...
    void testNegativeDateLess3day(){
        ...
        SelenideElement form = $("[action='/']");
        form.$("[data-test-id='city'] input").setValue("Москва");
        form.$("[data-test-id='date'] input").doubleClick().sendKeys(Keys.BACK_SPACE);        form.$("[data-test-id='date'] input").setValue(meetingDay(2));
        form.$("[data-test-id='name'] input").setValue("Владимир Владимиров");
        form.$("[data-test-id='phone'] input").setValue("+79642682654");
        form.$("[data-test-id='agreement']").click();
        form.$(".button__content").click();
    ...
    void testNegativeNameEmpty(){
        ...
        SelenideElement form = $("[action='/']");
        form.$("[data-test-id='city'] input").setValue("Москва");
        form.$("[data-test-id='date'] input").doubleClick().sendKeys(Keys.BACK_SPACE);        form.$("[data-test-id='date'] input").setValue(meetingDay(3));
        form.$("[data-test-id='phone'] input").setValue("+79642682654");
        form.$("[data-test-id='agreement']").click();
        form.$(".button__content").click();
    ...
    void testNegativePhoneEmpty(){
        ...
        SelenideElement form = $("[action='/']");
        form.$("[data-test-id='city'] input").setValue("Москва");
        form.$("[data-test-id='date'] input").doubleClick().sendKeys(Keys.BACK_SPACE);        form.$("[data-test-id='date'] input").setValue(meetingDay(7));
        form.$("[data-test-id='name'] input").setValue("Владимир Владимиров");
        form.$("[data-test-id='agreement']").click();
        form.$(".button__content").click();
